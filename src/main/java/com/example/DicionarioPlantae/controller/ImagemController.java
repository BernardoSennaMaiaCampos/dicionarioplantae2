...
public class ImagemController {
    ...
    public ResponseEntity<ImagemDTOUpdateResponse> atualizarStatusImagem(@Valid @RequestBody ImagemDTORequest imagemId){
    ...
    public ResponseEntity<ImagemDTOResponse>atualizarImagem(@Valid @PathVariable("participanteId") Integer IdImagem, @RequestBody ImagemDTORequest IdImagem){
    ...
    public ResponseEntity<ImagemDTOUpdateResponse> atualizarStatusImagem(@PathVariable("IdImagem") Integer IdImagem, @RequestBody ImagemDTOUpdateRequest imagemStatus){
        return ResponseEntity.ok(imagemService.atualizarImagem(imagemId, imagemStatus));
    }
